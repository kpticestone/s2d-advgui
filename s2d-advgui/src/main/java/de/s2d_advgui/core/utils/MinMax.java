...
public class MinMax {
    ...
    public void reset() {
        this.empty = true;
        this.x1 = this.y1 = this.x2 = this.y2 = this.width = this.height = 0f;
    }
    ...
    public boolean overlaps(@Nonnull MinMax pOther) {
        if (this.empty) return false;
        return this.x1 < pOther.x2 && this.x2 > pOther.x1 && this.y1 < pOther.y2 && this.y2 > pOther.y1;
    }
    ...
    public Vector2 getPosition(Vector2 vector2) {
        return this.toRect().getPosition(vector2);
    }

    // -------------------------------------------------------------------------------------------------------------------------
    public Vector2 getCenter(Vector2 vector2) {
        return this.toRect().getCenter(vector2);
    }
