...
public final class SwtDrawer_Batch<RM extends AResourceManager> extends ASwtDrawer {
    ...
    // -------------------------------------------------------------------------------------------------------------------------
    private void drawDownward(@Nonnull BitmapFont font, @Nullable CharSequence pStrg, float rX, float rY,
            boolean center) {
        if (pStrg == null) return;
    ...
    // -------------------------------------------------------------------------------------------------------------------------
    private void drawUpward(@Nonnull BitmapFont font, @Nullable CharSequence pStrg, float rX, float rY,
            boolean center) {
        if (pStrg == null) return;
        String[] lines = pStrg.toString().split("\n"); //$NON-NLS-1$
        float lh = 0;
    ...
    // -------------------------------------------------------------------------------------------------------------------------
    public void drawText(String pStrg, Rectangle pDims, int pAlign, float pFontSize, boolean pFontUseInt,
            Color useColor) {
