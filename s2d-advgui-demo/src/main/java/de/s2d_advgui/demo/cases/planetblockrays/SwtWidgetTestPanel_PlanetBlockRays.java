...
public class SwtWidgetTestPanel_PlanetBlockRays extends ASwtWidgetTestPanel {
    // -------------------------------------------------------------------------------------------------------------------------
    public SwtWidgetTestPanel_PlanetBlockRays(ISwtWidget<? extends Group> pParent) {
        super(pParent);
        ...
        SwtCanvas_PlanetBlockRays canvas2 = new SwtCanvas_PlanetBlockRays(this, drawerManager2);
